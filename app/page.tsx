...
export default function LandingPage() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "AI-powered personalized recommendations based on your health profile, air quality exposure, and symptom patterns.",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <Badge className="mb-6 sm:mb-8 bg-[#6200D9] text-white px-3 sm:px-4 py-1.5 sm:py-2 rounded-md text-xs sm:text-sm font-medium">
                <Award className="h-3 w-3 sm:h-4 sm:w-4 mr-1.5 sm:mr-2" />
                <span className="hidden xs:inline">Clinical-Grade Air Quality Health Platform</span>
            ...
            <div className={`transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <div className="relative max-w-6xl mx-auto px-2">
                <div className="bg-white dark:bg-slate-800 rounded-xl sm:rounded-2xl shadow-xl p-4 sm:p-6 md:p-8 border border-gray-200 dark:border-gray-700">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
                    {/* Air Quality Dashboard */}
                    <div className="space-y-4 sm:space-y-6">
                      <div className="flex items-center justify-between">
                        <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white">Current Air Quality</h3>
                        <Badge className="bg-green-100 text-green-800 border-green-200 text-xs sm:text-sm">Good</Badge>
                      </div>
                      <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 sm:p-6">
                        <div className="flex items-center justify-between mb-3 sm:mb-4">
                          <span className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">45</span>
                          <span className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">AQI</span>
                        </div>
                    ...
                    {/* Health Insights */}
                    <div className="space-y-4 sm:space-y-6">
                      <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white">AI Health Insights</h3>
                      <div className="space-y-3 sm:space-y-4">
                        <div className="flex items-start space-x-2 sm:space-x-3 p-3 sm:p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                          ...
                          <div className="min-w-0">
                            <p className="text-xs sm:text-sm font-medium text-blue-900 dark:text-blue-300">Optimal conditions detected</p>
                        ...
                        <div className="flex items-start space-x-2 sm:space-x-3 p-3 sm:p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                          ...
                          <div className="min-w-0">
                            <p className="text-xs sm:text-sm font-medium text-green-900 dark:text-green-300">Exercise Score: 87/100</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 md:gap-12">
            {features.map((feature, index) => (
              <div key={index} className="flex flex-col xs:flex-row space-y-4 xs:space-y-0 xs:space-x-4 sm:space-x-6">
                <div className={`w-10 h-10 sm:w-12 sm:h-12 ${feature.color} rounded-lg flex items-center justify-center flex-shrink-0 mx-auto xs:mx-0`}>
      ...
      <footer className="bg-gray-900 text-white py-12 sm:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
            <div className="col-span-1 sm:col-span-2 lg:col-span-2">
              <div className="flex items-center space-x-3 mb-4 sm:mb-6">
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-[#6200D9] rounded-lg flex items-center justify-center">
                  <Shield className="h-4 w-4 sm:h-6 sm:w-6 text-white" />
                </div>
                <span className="text-xl sm:text-2xl font-semibold">AtmoWise</span>
              </div>
          ...
          <div className="border-t border-gray-800 mt-8 sm:mt-12 pt-6 sm:pt-8 flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            <p className="text-gray-400 text-xs sm:text-sm">&copy; 2024 AtmoWise. All rights reserved.</p>
            <div className="flex flex-wrap justify-center sm:justify-end gap-4 sm:gap-6">
              <span className="text-gray-400 text-xs sm:text-sm">HIPAA Compliant</span>
              <span className="text-gray-400 text-xs sm:text-sm">SOC 2 Certified</span>
              <span className="text-gray-400 text-xs sm:text-sm">ISO 27001</span>
            </div>
          </div>
        </div>
      </footer>
