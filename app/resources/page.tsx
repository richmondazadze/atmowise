          ...
          <div className="px-8 py-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Expert guidance, research, and support for your health journey
                </p>
              </div>
            </div>
          </div>
              ...
              <Card className="shadow-sm">
                <CardHeader>
                  ...
                  <p className="text-sm text-gray-600">
                    Official guidelines and research from leading health
                    organizations
                  </p>
                </CardHeader>
                <CardContent>
            ...
            >
              <Card className="shadow-sm">
                <CardHeader>
                  ...
                  <p className="text-sm text-gray-600">
                    Find air quality information and health services in your
                    area
                  </p>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-3">
                      ...
                      <ul className="space-y-2 text-sm text-gray-600">
                        ...
                        <li>
                          • Report air quality concerns to local authorities
                        </li>
                      </ul>
                    </div>
                    <div className="space-y-3">
